		...
		<div class="inner">
			...
			<nav id="mainNav">
				<div class="inner">
					...
					<div class="panel">
						<ul id="topnav">
							<li class="current-menu-item"><a href="bkk.html"><strong> Trang chủ</strong><br /><span>Top</span></a></li>
							<li><a href="/detail"><strong>About us</strong><br /><span>Who we are ?</span></a>
							</li>
							<!--
